...
export default async function DashboardPage() {
 ...
 return (
  <div className="min-h-screen bg-gray-50 flex flex-col items-center py-12">
    ...
    {/* GRID KARTU - Kunci agar tidak melar ada di 'max-w-6xl' dan 'grid-cols-3' */}
    <div className="w-full max-w-6xl px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
      {programs?.map((program) => (
        <div key={program.id} className="bg-white rounded-[2.5rem] shadow-lg overflow-hidden border border-gray-100 flex flex-col">
          {/* Header Biru */}
