...
export default async function NewCommunityProgramPage() {
    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      <div className="max-w-2xl mx-auto px-4 md:px-6 py-8 md:py-10">
        <nav className="flex items-center gap-2 text-xs md:text-sm mb-6">
          ...
          <span className="text-slate-800 font-bold">Tambah Program</span>
        </nav>

        <h1 className="text-2xl md:text-3xl font-black text-slate-800 mb-8">Tambah Program Komunitas</h1>

        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-6 md:p-10">
          <CommunityProgramForm mode="create" />
        </div>
      </div>
    </div>
  );
